...
const achievements = [
  {
    title: "Logros",
    list: [
      "Selección Colombia campeonato panamericano de ruta",
      "Medalla de plata en la ruta de los Nacionales de Ciclismo",
      "Campeón de la primera válida de la Copa Talentos 'Sistecrédito' 2024",
    ],
    year: 2024,
  },
  {
    title: "Logros",
    list: [
      "Segundo en la Vuelta al Futuro 2022",
      "Récord nacional en ascenso(Filandia-Quimbaya)",
    ],
  },
];
